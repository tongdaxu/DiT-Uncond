...
from diffusion.model.nets.PixArt_blocks import TimestepEmbedder, Attention, WindowAttention
...
class DiTBlock(nn.Module):
    ...
    def __init__(self, hidden_size, num_heads, mlp_ratio=4.0, **block_kwargs):
        ...
        self.attn = WindowAttention(hidden_size, num_heads=num_heads, qkv_bias=True, **block_kwargs)
