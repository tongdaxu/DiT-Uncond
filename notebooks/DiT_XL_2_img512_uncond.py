...
data = dict(type='UncondDataset', root='/NEW_EDS/JJ_Group/xutd/PixArt-alpha/tools/imagenet_512_sd_list.txt', dummy_caption_path='/NEW_EDS/JJ_Group/xutd/PixArt-alpha/bins_share/dummy_caption.npz', transform='default_train')
image_size = 512
...
model = 'DiT_XL_2'
fp32_attention = True
load_from = "/NEW_EDS/JJ_Group/xutd/PixArt-alpha/bins_share/DiT-XL-2-512x512.pt"
